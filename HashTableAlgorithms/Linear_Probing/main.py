"""Demonstrate a hash table that resolves collisions through linear probing."""

from linear_probing_hash_table import LinearProbingHashTable


def main() -> None:
    """Build, display, and modify a linear probing hash table."""
    ...
    hash_table: LinearProbingHashTable[str, str] = LinearProbingHashTable()
